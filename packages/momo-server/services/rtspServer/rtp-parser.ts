...
class EasyRtpParser {
  ...
  static payloadTypesHash: Record<number, PayloadTypeInfo>;

  constructor() {}
  static parseRtpPacket(buf: Buffer): ParsedRtpPacket {
  ...
  static parseRtpPayloadType(payloadType: number): PayloadTypeInfo | undefined {
